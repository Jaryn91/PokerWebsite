...
namespace PokerWebsiteTests
{
    ...
    {
        public static IQueryable<Player> GetTestContext()
        {        
            ...
            var player4tournament2 = new Result { Tournament = tournament2, TournamentID = 2, Place = 1, Player = player4, PlayerID = 4, Points = 35, ID = 8 };
            var player5tournament2 = new Result { Tournament = tournament2, TournamentID = 2, Place = 3, Player = player5, PlayerID = 5, Points = 15, ID = 9 };
